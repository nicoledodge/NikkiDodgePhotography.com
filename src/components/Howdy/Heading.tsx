            ...
            <div className="container">
                <div className="row">
                    <div id="heading-box" className="col-lg-8 offset-lg-2 header-text mt-5">
                        <h2>
                            Hey, I'm <em>Nikki Dodge</em> – Your Wedding & Lifestyle <em>Photographer</em>
                        </h2>
                        <p>
                            I’m a <b>natural light photographer</b> specializing in <b>weddings, couples, and portraits</b>.

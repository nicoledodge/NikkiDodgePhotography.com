    ...
    return (
        <section className="contact-us">
            <div className="container">
                <div className="row">
                    <div className="col-lg-12">
                        <div className="section-heading text-center">
                            ...
                            <h4>
                                Don't Be Shy <em></em> to contact the <em>Photographer Now</em>
                            </h4>
                        </div>
                    </div>
                ...
                <br />
                <a href="mailto:SnapX@company.com">SnapX@company.com</a>
              </span>
                        </div>
                    </div>
                    ...
                    <div className="col-lg-4">
                        <div className="info-item">
                            ...
                            <span>
                <a href="#">155 Michigan Ave, Chicago,<br />IL 60601, United States</a>
              </span>
                        </div>
                    </div>
